...
- `delegation_credential`: Being able to delegate the authority (for taking health related decision) to another person. It is accompanied by [sample delegation_credential](delegation_credential.json)
